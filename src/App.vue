        ...
        <div id="info-screen">
          <Header :pokemonId="this.pokemonId">
            <template v-slot:info v-if="this.$route.name === 'Pokemon List'">
              <p>
                #{{ this.pokemonId }}
                <span class="name">{{ this.pokemonName }}</span>
              </p>
            </template>
          </Header>
        </div>
...
<script>
import Nav from "./components/navigation/nav/Nav.vue";
import Header from "./components/header/Header.vue";
import Footer from "./components/footer/Footer.vue";
import Keyboard from "./components/navigation/keyboard/Keyboard.vue";
import Cross from "./components/navigation/cross/Cross.vue";
